...
#define UE_ENGINE_DIRECTORY "E:/Program Files (x86)/Epic Games/UE_4.26/Engine/"
...
#define UE_PROJECT_NAME HostageMechanic
#define UE_TARGET_NAME HostageMechanic
